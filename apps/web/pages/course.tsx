            ...
            <div className="flex flex-col  gap-5" >
                {calendars.length > 0 && calendars.map(calendar =>
                    <Link
                        ...
                        className="flex sm:flex-row gap-6 flex-col items-center justify-between border rounded-xl dark:bg-black dark:border-white dark:hover:bg-white border-gray-200 bg-orange-50/20 py-5 px-4 shadow-sm sm:gap-2 hover:bg-gray-50 hover:shadow transition-all duration-300">
                        ...
                        <div >
                            <div className="text-lack hover:text-white py-2 px-5 bg-white shadow rounded-xl  whitespace-nowrap dark:border dark:hover:text-white dark:bg-black dark:border-white dark:hover:bg-white">{t('goToCalendar')}</div>
                        </div>
